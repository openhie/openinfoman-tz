...
<body>
  ...
  <table border="1" style="border-color:blue"><tr>
    <td>
      <table><tr>
  <?php
  $host="http://localhost:8984/CSD";
  $docs=get_docs();
  echo "<td>Source CSD Document<br><select name='src_doc_name'>".display_docs($docs,'src_doc_name')."</select></td>
  <td>&nbsp;</td><td>Entity Type<br><select name='entity_type'>
  <option value='facility'>Facility</option>
  <option value='provider'>Provider</option>
  <option value='organization'>Organization</option>
  <option value='service'>Service</option>
  </select></td></tr><tr>
  <td>Target CSD Document<br><select name='target_doc_name'>".display_docs($docs,'target_doc_name')."</select></td>
  <td></td></td><td>Rows Per Page<br><select name='max_rows'>
  <option>2</option>
  <option>5</option>
  <option>10</option>
  ...
  <td></td><td></td><td></td><td>&nbsp;</td><td colspan="5"><input type='button' value='Load Facilities' name='set_docs' onclick='display_report("","","")' class="btn btn-primary"></td>
  <?php
  }
  ?>
  </table>
